...
const PROD_RENDERER_CSP = "default-src 'self'; base-uri 'self'; object-src 'none'; script-src 'self'; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https://lanaya.space https://www.lanaya.space; media-src 'self' data: blob: https://lanaya.space https://www.lanaya.space; font-src 'self' data:; connect-src 'self' https://lanaya.space https://www.lanaya.space wss://lanaya.space wss://www.lanaya.space; worker-src 'self' blob:;";
