...
const SETTINGS_NAV_ICON_PATHS = {
  ...
  integrations: (
    <>
      <path d="M9.2 7.2 7.9 5.9a3.1 3.1 0 0 0-4.4 4.4l2.3 2.3a3.1 3.1 0 0 0 4.4 0l.7-.7" />
      <path d="M14.8 16.8l1.3 1.3a3.1 3.1 0 0 0 4.4-4.4l-2.3-2.3a3.1 3.1 0 0 0-4.4 0l-.7.7" />
