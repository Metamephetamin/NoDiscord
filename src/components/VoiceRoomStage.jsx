...
const VOICE_STAGE_CONNECTION_COPY = {
  connecting: {
    title: "\u041f\u043e\u0434\u043a\u043b\u044e\u0447\u0435\u043d\u0438\u0435 \u043a \u0433\u043e\u043b\u043e\u0441\u0443",
    detail: "\u0413\u043e\u0442\u043e\u0432\u0438\u043c \u043a\u043e\u043c\u043d\u0430\u0442\u0443 \u0438 \u0430\u0443\u0434\u0438\u043e.",
  },
  reconnecting: {
    title: "\u0412\u043e\u0441\u0441\u0442\u0430\u043d\u0430\u0432\u043b\u0438\u0432\u0430\u0435\u043c \u0441\u043e\u0435\u0434\u0438\u043d\u0435\u043d\u0438\u0435",
    detail: "\u042d\u0444\u0438\u0440 \u0438 \u0437\u0432\u0443\u043a \u0432\u0435\u0440\u043d\u0443\u0442\u0441\u044f \u043f\u043e\u0441\u043b\u0435 reconnect.",
  },
  disconnected: {
    title: "\u0421\u043e\u0435\u0434\u0438\u043d\u0435\u043d\u0438\u0435 \u043f\u0440\u0435\u0440\u0432\u0430\u043d\u043e",
    detail: "\u041f\u043e\u043f\u0440\u043e\u0431\u0443\u0439\u0442\u0435 \u043f\u0435\u0440\u0435\u0437\u0430\u0439\u0442\u0438 \u0432 \u0433\u043e\u043b\u043e\u0441\u043e\u0432\u043e\u0439 \u043a\u0430\u043d\u0430\u043b.",
  },
  "permission-denied": {
    title: "\u041d\u0435\u0442 \u0434\u043e\u0441\u0442\u0443\u043f\u0430 \u043a \u043c\u0438\u043a\u0440\u043e\u0444\u043e\u043d\u0443",
    detail: "\u0420\u0430\u0437\u0440\u0435\u0448\u0438\u0442\u0435 \u0434\u043e\u0441\u0442\u0443\u043f \u0432 \u0441\u0438\u0441\u0442\u0435\u043c\u0435 \u0438 \u0431\u0440\u0430\u0443\u0437\u0435\u0440\u0435.",
  },
  "device-missing": {
    title: "\u041c\u0438\u043a\u0440\u043e\u0444\u043e\u043d \u043d\u0435 \u043d\u0430\u0439\u0434\u0435\u043d",
    detail: "\u041f\u043e\u0434\u043a\u043b\u044e\u0447\u0438\u0442\u0435 \u0443\u0441\u0442\u0440\u043e\u0439\u0441\u0442\u0432\u043e \u0438\u043b\u0438 \u0432\u044b\u0431\u0435\u0440\u0438\u0442\u0435 \u0434\u0440\u0443\u0433\u043e\u0435 \u0432 \u043d\u0430\u0441\u0442\u0440\u043e\u0439\u043a\u0430\u0445.",
  },
  "session-failed": {
    title: "\u041d\u0435 \u0443\u0434\u0430\u043b\u043e\u0441\u044c \u043f\u043e\u0434\u0433\u043e\u0442\u043e\u0432\u0438\u0442\u044c \u0433\u043e\u043b\u043e\u0441",
    detail: "\u0421\u0435\u0441\u0441\u0438\u044f \u0437\u0432\u043e\u043d\u043a\u0430 \u0438\u043b\u0438 LiveKit-\u0442\u043e\u043a\u0435\u043d \u043d\u0435 \u043f\u0440\u0438\u043d\u044f\u0442\u044b. \u041f\u0435\u0440\u0435\u0437\u0430\u0439\u0434\u0438\u0442\u0435 \u0432 \u043a\u0430\u043d\u0430\u043b.",
  },
};
...
export default function VoiceRoomStage({
  ...
  const connectionPhase = String(connectionState?.phase || "");
  const connectionCopy = VOICE_STAGE_CONNECTION_COPY[connectionPhase] || null;
  const shouldShowConnectionStatus = Boolean(connectionCopy && connectionPhase !== "connected" && connectionPhase !== "idle");
  ...
  return (
    <section className={`voice-room-stage ${activeStage ? "voice-room-stage--active-stream" : ""}`}>
      ...
      {shouldShowConnectionStatus ? (
        <div className={`voice-room-stage__connection-state voice-room-stage__connection-state--${connectionPhase}`} role="status">
          <strong>{connectionCopy.title}</strong>
          <span>{connectionState?.message || connectionCopy.detail}</span>
        </div>
      ) : null}
