        ...
        {activeServer && !isVoiceStageVisible && !isVoicePreviewVisible ? (
          <div className={`chat__topbar ${isVoicePreviewVisible ? "chat__topbar--voice-preview" : ""}`}>
            <div className="chat__topbar-title">
              <span className="chat__topbar-symbol" aria-hidden="true">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" className="bi bi-hash" viewBox="0 0 16 16" stroke="currentColor" strokeWidth="1.45" strokeLinecap="round">
                  <path d="M6.35 3.2 5.15 12.8" />
                  <path d="M10.85 3.2 9.65 12.8" />
                  <path d="M3.45 6.15h10.2" />
                  <path d="M2.9 9.85h10.2" />
                </svg>
              </span>
              <div className="chat__topbar-copy">
                <strong>
                  <span className="chat__topbar-name">{isVoicePreviewVisible ? selectedVoiceChannel.name : getChannelDisplayName(currentTextChannel?.name || "channel", "text")}</span>
