...
function BootstrapEyeIcon({ visible }) {
  return (
    <svg
      aria-hidden="true"
      className={`auth-password-toggle__icon bi ${visible ? "bi-eye-slash" : "bi-eye"}`}
      focusable="false"
      viewBox="0 0 16 16"
    >
      {visible ? (
        <>
          <path d="M13.359 11.238C15.06 9.72 16 8 16 8s-3-5.5-8-5.5a7.03 7.03 0 0 0-2.79.588l.77.771A5.94 5.94 0 0 1 8 3.5c2.12 0 3.879 1.168 5.168 2.457A13.13 13.13 0 0 1 14.828 8q-.086.13-.195.288c-.335.48-.83 1.12-1.465 1.755a12 12 0 0 1-.517.486z" />
...
function PasswordInput({
  ...
  return (
    <span className="auth-password-field">
      ...
      >
        <BootstrapEyeIcon visible={visible} />
      </button>
    </span>
  );
}
