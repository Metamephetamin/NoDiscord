...
export const normalizeFriend = (friend) => ({
  ...
  profileCustomization: friend?.profileCustomization || friend?.profile_customization || friend?.profileCustomizationJson || friend?.profile_customization_json || null,
  ...
  friendshipCreatedAt: String(friend?.friendshipCreatedAt || friend?.friendship_created_at || friend?.friendsSinceAt || friend?.friends_since_at || ""),
  mutualFriendsCount: Math.max(0, Number(friend?.mutualFriendsCount ?? friend?.mutual_friends_count ?? 0) || 0),
  lastDirectMessageAt: String(friend?.lastDirectMessageAt || friend?.last_direct_message_at || ""),
