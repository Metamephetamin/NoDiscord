...
export const MAX_FILE_SIZE_BYTES = 30 * 1024 * 1024 * 1024;
export const MAX_FILE_SIZE_LABEL = "30 ГБ";
...
export const VOICE_RECORDING_AUDIO_BITS_PER_SECOND = 128000;
export const VOICE_RECORDING_SAMPLE_RATE = 48000;
export const VOICE_HIGH_PASS_FREQUENCY_HZ = 85;
...
export const VOICE_PRESENCE_GAIN_DB = 1.6;
export const VOICE_HIGH_SHELF_FREQUENCY_HZ = 6200;
export const VOICE_HIGH_SHELF_GAIN_DB = 0.8;
export const VOICE_LOW_PASS_FREQUENCY_HZ = 13000;
export const VOICE_OUTPUT_GAIN = 1.12;
