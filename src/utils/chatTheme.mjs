export const CHAT_THEME_OPTIONS = Object.freeze([
  {
    ...
    variables: {
      ...
      "--chat-message-incoming-bg": "linear-gradient(135deg, rgba(31, 41, 58, 0.96), rgba(39, 50, 70, 0.94))",
      "--chat-message-own-bg": "linear-gradient(135deg, rgba(45, 66, 104, 0.96), rgba(57, 72, 116, 0.94))",
      ...
      "--chat-topbar-bg": "linear-gradient(180deg, rgba(17, 22, 34, 0.97), rgba(11, 14, 22, 0.95))",
  ...
  },
  {
    ...
    variables: {
      ...
      "--chat-message-incoming-bg": "linear-gradient(135deg, rgba(57, 75, 118, 0.94), rgba(88, 68, 126, 0.92))",
      "--chat-message-own-bg": "linear-gradient(135deg, rgba(53, 107, 164, 0.96), rgba(145, 78, 183, 0.94))",
      ...
      "--chat-topbar-bg": "linear-gradient(135deg, rgba(26, 38, 64, 0.95), rgba(54, 36, 70, 0.92))",
  ...
  },
  {
    ...
    variables: {
      ...
      "--chat-message-incoming-bg": "linear-gradient(135deg, rgba(31, 89, 96, 0.94), rgba(42, 83, 120, 0.92))",
      "--chat-message-own-bg": "linear-gradient(135deg, rgba(24, 129, 123, 0.96), rgba(42, 105, 162, 0.94))",
      ...
      "--chat-topbar-bg": "linear-gradient(135deg, rgba(12, 43, 48, 0.95), rgba(18, 43, 66, 0.92))",
  ...
  },
  {
    ...
    variables: {
      ...
      "--chat-message-incoming-bg": "linear-gradient(135deg, rgba(54, 65, 94, 0.94), rgba(70, 73, 104, 0.92))",
      "--chat-message-own-bg": "linear-gradient(135deg, rgba(55, 100, 153, 0.96), rgba(132, 83, 162, 0.94))",
      ...
      "--chat-topbar-bg": "linear-gradient(135deg, rgba(47, 58, 83, 0.9), rgba(80, 60, 96, 0.84))",
