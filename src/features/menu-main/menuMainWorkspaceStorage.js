...
export const readWorkspaceStateFromStorageKey = (storageKey) => {
  ...
  try {
    ...
    return {
      ...
      friendsPageSection: ["conversations", "store"].includes(parsedValue.friendsPageSection) ? parsedValue.friendsPageSection : "friends",
...
export const writeWorkspaceStateToStorageKey = (storageKey, state) => {
  ...
  try {
    window.localStorage.setItem(storageKey, JSON.stringify({
      ...
      friendsPageSection: ["conversations", "store"].includes(state?.friendsPageSection) ? state.friendsPageSection : "friends",
