...
const DEFAULT_DENOISER_BY_PROFILE = Object.freeze({
  [AUDIO_PROCESSING_PROFILE_TRANSPARENT]: AUDIO_DENOISER_MODE_OFF,
...
function getAudioPipelineRuntimeOptions(mode, profile, options = {}) {
  ...
  const deepFilterConfig = {
    attenLimDb: profile === AUDIO_PROCESSING_PROFILE_NOISY_ROOM ? 80 : 60,
    postFilterBeta: profile === AUDIO_PROCESSING_PROFILE_TRANSPARENT ? 0 : 0.02,
    minDbThresh: -18,
    maxDbErbThresh: 35,
    maxDbDfThresh: 35,
