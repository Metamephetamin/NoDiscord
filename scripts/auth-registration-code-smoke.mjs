...
assert(authSource.includes("startPasswordResetFlow"), "Password login should expose password reset flow.");
assert(authSource.includes("/auth/request-password-reset-code"), "Password reset should request an email code.");
assert(authSource.includes("/auth/reset-password"), "Password reset should submit a new password.");
assert(authSource.includes("auth-section--password-reset"), "Password reset should render inline inside the auth card.");
