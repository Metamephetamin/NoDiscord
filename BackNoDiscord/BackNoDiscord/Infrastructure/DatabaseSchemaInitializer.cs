...
public static class DatabaseSchemaInitializer
{
    public static async Task InitializeAsync(IServiceProvider services)
    {
        ...
        await dbContext.Database.ExecuteSqlRawAsync(
            ...
            CREATE TABLE IF NOT EXISTS banned_identity_records (
                id integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
            ...
            CREATE UNIQUE INDEX IF NOT EXISTS ix_banned_identity_active_lookup
                ON banned_identity_records (identity_type, identity_hash)
                WHERE revoked_at IS NULL;
            CREATE INDEX IF NOT EXISTS ix_banned_identity_source_active
                ON banned_identity_records (source_user_id, revoked_at);
            CREATE INDEX IF NOT EXISTS ix_banned_identity_type_active
                ON banned_identity_records (identity_type, revoked_at);
            ...
            CREATE INDEX IF NOT EXISTS ix_server_audit_logs_actor_user_id
                ON server_audit_logs (actor_user_id);
            ...
            CREATE INDEX IF NOT EXISTS ix_email_verification_codes_user_id_purpose ON email_verification_codes (user_id, purpose);
            ...
            CREATE TABLE IF NOT EXISTS chat_channel_read_states (
                id integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
            ...
            CREATE UNIQUE INDEX IF NOT EXISTS ix_chat_channel_read_states_user_channel
                ON chat_channel_read_states (user_id, channel_id);
            CREATE INDEX IF NOT EXISTS ix_chat_channel_read_states_channel_last_read_at
                ON chat_channel_read_states (channel_id, last_read_at);
            CREATE TABLE IF NOT EXISTS chat_moderation_reports (
                id integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
            ...
            CREATE INDEX IF NOT EXISTS ix_chat_moderation_reports_server_status_created
                ON chat_moderation_reports (server_id, status, created_at DESC);
            CREATE INDEX IF NOT EXISTS ix_chat_moderation_reports_server_target_created
                ON chat_moderation_reports (server_id, target_user_id, created_at DESC);
            ...
            CREATE INDEX IF NOT EXISTS ix_user_reports_status_created
                ON user_reports (status, created_at DESC);
            CREATE INDEX IF NOT EXISTS ix_user_reports_target_status_created
                ON user_reports (target_user_id, status, created_at DESC);
            CREATE INDEX IF NOT EXISTS ix_user_reports_reporter_target_created
                ON user_reports (reporter_user_id, target_user_id, created_at DESC);
            ...
            CREATE INDEX IF NOT EXISTS ix_chat_moderation_actions_active_lookup
                ON chat_moderation_actions (server_id, target_user_id, action_type, revoked_at, expires_at);
            CREATE INDEX IF NOT EXISTS ix_chat_moderation_actions_server_created
                ON chat_moderation_actions (server_id, created_at DESC);
            ...
            ALTER TABLE IF EXISTS users
                ADD COLUMN IF NOT EXISTS location_visibility text NOT NULL DEFAULT 'none';
            ALTER TABLE IF EXISTS users
            ...
            CREATE INDEX IF NOT EXISTS ix_chatmessages_active_channelid_timestamp ON chatmessages (channelid, timestamp) WHERE is_deleted = false;
            CREATE INDEX IF NOT EXISTS ix_chatmessages_active_channelid_id ON chatmessages (channelid, id) WHERE is_deleted = false;
            ...
            CREATE INDEX IF NOT EXISTS ix_friend_requests_user_low_status_created_at ON friend_requests (user_low_id, status, created_at);
            CREATE INDEX IF NOT EXISTS ix_friend_requests_user_high_status_created_at ON friend_requests (user_high_id, status, created_at);
            CREATE INDEX IF NOT EXISTS ix_user_integrations_user_profile_status_activity ON user_integrations (user_id, display_in_profile, use_as_status, activity_updated_at);
